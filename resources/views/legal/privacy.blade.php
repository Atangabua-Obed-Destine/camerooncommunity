<x-layouts.guest>
    ...
    @php
        $sections = [
            ...
            [
                'icon' => '💬',
                'en' => ['title' => 'Your messages belong to you', 'body' => "Conversations in The Yard are stored to deliver them across your devices. We do not read them. We do not train AI on them. Reports of abuse are reviewed by humans, not algorithms."],
