        ...
        <div x-transition:enter="transition ease-out duration-400"
            ...
            @php
                ...
                $chipRounds = [
                    ...
                    [
                        ['en' => '💬 I want to chat in GoConnect',     'fr' => '💬 Je veux discuter dans GoConnect'],
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="text-center py-8">
                    ...
                    <p class="text-sm text-slate-500" x-text="$store.lang.t(
                        'No communities found for your location yet. You can discover more in GoConnect!',
                        'Aucune communauté trouvée pour votre localisation. Vous en trouverez plus dans GoConnect !'
                    )"></p>
                </div>
                @endforelse
            ...
            <div class="relative bg-gradient-to-br from-cm-green via-blue-700 to-cm-green-light px-8 py-10 text-white overflow-hidden">
                ...
                <div class="relative">
                    ...
                    <p class="text-white/80 text-base"
                       ...
                       x-transition:enter-start="opacity-0"
                       x-transition:enter-end="opacity-100"
                       x-text="$store.lang.t('Welcome to the family. GoConnect awaits.', 'Bienvenue dans la famille. GoConnect vous attend.')"></p>
                </div>
            </div>
            ...
            <div class="p-8 space-y-5"
                ...
                <div class="grid grid-cols-3 gap-3">
                    <div class="bg-slate-50 rounded-xl p-4 border border-slate-100">
                        ...
                        <p class="text-[10px] text-slate-500 mt-0.5" x-text="$store.lang.t('GoConnect', 'GoConnect')"></p>
                    </div>
                    <div class="bg-slate-50 rounded-xl p-4 border border-slate-100">
                        <div class="text-2xl mb-2">🤲</div>
