...
<aside class="yard-icon-sidebar" x-data="{ expanded: true, tooltip: '' }" :class="{ 'yard-icon-sidebar--expanded': expanded }">
    ...
    <div class="yard-icon-sidebar__top">
        ...
        <a href="{{ route('yard') }}"
           ...
           @mouseenter="tooltip = $store.lang.t('GoConnect', 'GoConnect')" @mouseleave="tooltip = ''">
            ...
            <span class="yard-icon-sidebar__label" x-text="$store.lang.t('GoConnect', 'GoConnect')"></span>
        </a>
        ...
        {{-- GoMarket — live module (marketplace) --}}
        <a href="{{ route('marketplace.index') }}"
           class="yard-icon-sidebar__item {{ $active === 'marketplace' ? 'yard-icon-sidebar__item--active' : '' }}"
           @mouseenter="tooltip = $store.lang.t('GoMarket', 'GoMarket')" @mouseleave="tooltip = ''">
        ...
        {{-- GoParcel --}}
        <div class="yard-icon-sidebar__item yard-icon-sidebar__item--soon"
             @mouseenter="tooltip = $store.lang.t('GoParcel — Coming Soon', 'GoParcel — Bientôt')" @mouseleave="tooltip = ''">
            ...
            <span class="yard-icon-sidebar__label">GoParcel</span>
            <span class="yard-icon-sidebar__badge-soon" x-text="$store.lang.t('Soon', 'Bientôt')"></span>
        </div>
        ...
        {{-- GoPartner --}}
        <div class="yard-icon-sidebar__item yard-icon-sidebar__item--soon"
             @mouseenter="tooltip = $store.lang.t('GoPartner — Coming Soon', 'GoPartner — Bientôt')" @mouseleave="tooltip = ''">
            ...
            <span class="yard-icon-sidebar__label">GoPartner</span>
            <span class="yard-icon-sidebar__badge-soon" x-text="$store.lang.t('Soon', 'Bientôt')"></span>
        </div>
    </div>
